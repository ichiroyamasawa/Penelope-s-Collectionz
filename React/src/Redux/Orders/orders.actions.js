...
export const setUserOrderHistory = (history) => ({
  type: ordersTypes.SET_USER_ORDER_HISTORY_START,
  payload: history,
});

export const getClientOrderHistory = (uid) => ({
  type: ordersTypes.GET_CLIENT_ORDER_HISTORY_START,
  payload: uid,
});

export const setClientOrderHistory = (history) => ({
  type: ordersTypes.SET_CLIENT_ORDER_HISTORY_START,
  payload: history,
});
...
export const setOrderComplete = (orderID) => ({
  type: ordersTypes.SET_ORDER_COMPLETE,
  payload: orderID,
});
